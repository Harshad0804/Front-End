...
function Blog() {
    ...
    return (
        <div>
            <Navbar />
            <Header title="Our Blog & News" name="Blog & News" />
                                            ...
                                            <div className="blog-item">
                                                ...
                                                <div className="blog-content rounded-bottom p-4">
                                                    ...
                                                    <div className="blog-comment my-3">
                                                        ...
                                                        <div className="small"><span className="fa fa-comment-alt text-primary" /><span className="ms-2">{data.comment} Comments</span></div>
                                                    </div>
